...
public class RefreshLayout extends ViewGroup
    ...
    protected void initDefaultRefreshView() {
        mRefreshView = new DefaultRefreshHeader(getContext());
        mIRefreshStatus = (IRefreshStatus) mRefreshView;
        addView(mRefreshView, new MarginLayoutParams(LayoutParams.MATCH_PARENT, mSpinnerSize));
    }
